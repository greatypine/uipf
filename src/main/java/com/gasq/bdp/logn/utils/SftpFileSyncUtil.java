...
public class SftpFileSyncUtil {
	protected static Logger logger = Logger.getLogger(SftpFileSyncUtil.class);
	/**
	 ...
	 * @param outputFile 
	 */
	public static void sshSftp(String ip, String user, String psw, int port, String outputFile) throws Exception {
		...
		try {
			...
			OutputStream outstream = sftp.put(outputFile);
	...
	public static void main(String[] args) {
		try {
			...
			String outputFile = InitProperties.LOG_FILES_DIR + "/" + date + ".log";
			SftpFileSyncUtil.sshSftp("10.16.31.166", "root", "Adminmock1234", 22,outputFile);
		} catch (Exception e) {
			logger.info(e.getMessage(),e);
		}
	}
