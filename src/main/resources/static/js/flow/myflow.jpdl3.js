...
$.extend(true,myflow.config.tools.states,{
	start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : content+'/static/js/flow/img/16/start_event_empty.png',width : 16, height:16},
				props : {
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : content+'/static/js/flow/img/16/end_event_terminate.png',width : 16, height:16},
				props : {
			...
			'end-cancel' : {type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : content+'/static/js/flow/img/16/end_event_cancel.png',width : 16, height:16},
				props : {
			...
			'end-error' : {type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src :content+'/static/js/flow/img/16/end_event_error.png',width : 16, height:16},
				props : {
			...
			state : {type : 'state',
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : content+'/static/js/flow/img/16/task_empty.png',width : 16, height:16},
				props : {
			...
			fork : {type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : content+'/static/js/flow/img/16/gateway_parallel.png',width :16, height:16},
				props : {
			...
			join : {type : 'join',
				...
				props : {
					...
					temp1: {name:'temp1', label: '文本', value:'', editor: function(){return new myflow.editors.inputEditor();}},
					temp2: {name:'temp2', label : '选择', value:'', editor: function(){return new myflow.editors.selectEditor({"type":1});}}
				}},
			task : {type : 'task',
				name : {text:'<<task>>'},
				text : {text:'任务'},
				...
				props : {
					...
					temp1: {name:'temp1', label : '类型', value:'', editor: function(){return new myflow.editors.selectEditor({"type":1});}},
					temp2: {name:'temp2', label : '任务', value:'', editor: function(){return new myflow.editors.selectEditor({"type":2});}}
				}}
});
})(jQuery);
